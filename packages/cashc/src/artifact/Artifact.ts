import {
  AbiFunction, Artifact, Script, scriptToAsm, SourceMap,
...
export function generateArtifact(ast: Ast, script: Script, source?: string, sourceMap?: SourceMap): Artifact {
  const { contract } = ast;
