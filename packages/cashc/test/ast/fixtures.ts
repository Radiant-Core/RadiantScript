...
import { BytesType, PrimitiveType } from '@radiantscript/utils';
import {
  SourceFileNode,
  ContractNode,
  Ast,
  ...
  },
  {
    ...
    ast: new SourceFileNode(
      new ContractNode(
        ...
        undefined,
        [
          new VariableDefinitionNode(PrimitiveType.STRING, '', 'y', new IdentifierNode('_y')),
          new VariableDefinitionNode(PrimitiveType.INT, '', 'x', new IdentifierNode('_x')),
        ],
      ),
    ),
  },
  ...
  },
  {
    ...
    ast: new SourceFileNode(
      new ContractNode(
        ...
        undefined,
        [
          new VariableDefinitionNode(PrimitiveType.INT, '', 'priceTarget', new IdentifierNode('_priceTarget')),
          new VariableDefinitionNode(PrimitiveType.INT, '', 'minBlock', new IdentifierNode('_minBlock')),
          new VariableDefinitionNode(PrimitiveType.PUBKEY, '', 'oraclePk', new IdentifierNode('_oraclePk')),
          new VariableDefinitionNode(PrimitiveType.PUBKEY, '', 'ownerPk', new IdentifierNode('_ownerPk')),
        ],
      ),
    ),
  },
  ...
  },
  {
    ...
    ast: new SourceFileNode(
      new ContractNode(
        ...
        undefined,
        [
          new VariableDefinitionNode(PrimitiveType.INT, '', 'period', new IdentifierNode('_period')),
          new VariableDefinitionNode(PrimitiveType.INT, '', 'pledge', new IdentifierNode('_pledge')),
          new VariableDefinitionNode(new BytesType(20), '', 'funder', new IdentifierNode('_funder')),
          new VariableDefinitionNode(new BytesType(20), '', 'recipient', new IdentifierNode('_recipient')),
        ],
      ),
    ),
  },
